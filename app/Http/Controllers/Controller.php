...
class Controller extends BaseController
{
    ...
    public function getIndex()
    {
        ...
        if ($status != $this->location->is_open &&
            strtotime($this->getTimezoneAdjusted($this->location->updated_at)) > strtotime(date("Y-m-d H:i:s")) - 43140
        ) {
    ...
    public function postIndex(Request $request)
    {
        ...
        DB::insert('
        INSERT INTO change_requests (location_id, is_open, ip_address)
        VALUES (?, ?, ?)',
            [
                $this->location->id,
                $is_open,
    ...
    private function getLocationHours()
    {
        return [
            ...
            "Sat" => ["12:00 AM" => "02:00 AM", "05:00 PM" => "11:59 PM"],
        ];
    }
